...
export default function Testcomponent() {
	...
	return (
		<div>
			...
			<div className="mx-auto  sm:w-3/4 md:w-2/4 fixed inset-x-0 z-10 mt-14 opacity-90">
				<div className=" shadow-md rounded-md text-center">
				<div className="bg-red-500 text-white  my-4  gap-2 text-md flex items-center justify-center ">
		...
		// mx-auto sm:w-3/4 md:w-2/4 fixed inset-x-0 top-10 65.2.68.51
	)
}
